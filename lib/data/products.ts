...
// Precios sincronizados con el Excel 2026: el PRECIO de fábrica se toma como
// mayorista (redondeado al mil) y el detal es el doble. Refs sin fila en el
// Excel conservan su precio anterior o llevan un estimado (marcado abajo).
...
export const products: Product[] = [
  // ── PIJAMAS SATÍN ESPECIALES ──
  {
    ...
    inStock: true,
    description:
      'Conjunto de blusa de tiras y pantalón largo en satín sublimado, suave y fresco. Elige tu estampado: cerezas, corazones, Snoopy o floral. Perfecto para noches románticas.',
  },
  {
    id: 'p-039',
    ...
    inStock: true,
    description:
      'Conjunto de blusa de tiras y short en satín sublimado con varios estampados encantadores: Snoopy, floral, cerezas, corazones, Minnie y ositos.',
  },
  {
  ...
  // ── LENCERÍA - BABY DOLL ──
  {
    ...
    inStock: true,
    description:
      'Conjunto de short y blusa unicolor en piel de durazno con tiritas ruffle (golas) y moñito delicado. Tela suave y fresca, ideal para dormir. Disponible en piel de durazno, rojo, amarillo, menta, azul y blanco.',
  },
  ...
  // ── CAMISONES ──
  {
    ...
    name: 'Ref 071 — Camisón Satín de Tiras',
    category: 'camisones',
    images: [
    ...
    inStock: true,
    description:
      'Camisón corto en satín suave con tiritas ajustables y escote en V con encaje. Elige tu estampado: flamencos nude, corazones lila, floral azul o gatitos rosa.',
  },
  {
    id: 'p-107',
    ...
    inStock: true,
    description:
      'Camisón fresco en algodón tipo esqueleto (racerback) con frases estampadas. Cómodo para dormir. Diseños: Paris, Don\'t Overthink It, Be the Change y Dreams.',
  },
  ...
  // ── REFS NORMALES (ALGODÓN PIEL DE DURAZNO) ──
  {
    id: 'p-007',
  ...
  },
  {
    ...
    inStock: true,
    description:
      'Blusa de tiras con frase y pantalón largo en piel de durazno estampado. Varios diseños para elegir: Follow Heart, Be Happy, Sweetness, Be Real, Little Sweet y Milk Shakes.',
  },
  {
    id: 'p-002',
  ...
  },
  {
    ...
    name: 'Ref 069 — Conjunto Capri + Camisa de Botones',
    category: 'capri',
    images: [
    ...
    inStock: true,
    description:
      'Conjunto de camisa de botones manga corta y capri a juego, estilo clásico abotonado. Tela suave tipo franela. Estampados: corazones, paisley, cachemir, flores aqua y flores lila.',
  },
  {
    id: 'p-sinref-menta',
  ...
  // ── MATERNIDAD / LEVANTADORAS ──
  {
    ...
    inStock: true,
    description:
      'Combo bata/camisón de maternidad con apertura para lactancia + enterito de bebé a juego. Varios estampados tiernos para elegir. El regalo perfecto para baby shower.',
  },

  // ── BATAS PIEL DURAZNO / FELPA ──
  {
    id: 'p-401',
