...
export const products: Product[] = [
  ...
  },
  {
    ...
    inStock: true,
    description:
      'Top menta con pantalón largo a cuadros en color teal. Estilo elegante para descansar. (Precio estimado — no está en el Excel oficial.)',
  },
  ...
  // ══════════ PANTALÓN SATÍN ══════════
  {
    ...
    inStock: true,
    description:
      'Conjunto de blusa de tiras y pantalón largo en satín sublimado, suave y fresco. Elige tu estampado: cerezas, corazones, Snoopy o floral.',
  },
  ...
  },
  {
    ...
    inStock: true,
    description:
      'Pijama corta en satín negro con estampado Mickey & Minnie y corazones. (Precio estimado — no está en el Excel oficial.)',
  },
  ...
  },
  {
    ...
    inStock: true,
    description:
      'Pijama niño manga larga + pantalón en piel de durazno, para clima frío. Varios personajes: Sonic, Spider-Man, Minecraft, Labubu y Roblox.',
  },
