...
export const products: Product[] = [
  ...
  },
  {
    ...
    colors: ['Sweet Dreams Stitch', 'Good Night Vaquita', 'Huntrix', 'Chicas Superpoderosas'],
    colorImages: {
      'Sweet Dreams Stitch': '/products/ref-064-nina-pijama-manga-corta/photo-1.png?v=1',
      'Good Night Vaquita': '/products/ref-064-nina-pijama-manga-corta/photo-2.png?v=1',
      Huntrix: '/products/ref-064-nina-pijama-manga-corta/photo-3.png?v=1',
      'Chicas Superpoderosas': '/products/ref-064-nina-pijama-manga-corta/photo-4.png?v=1',
    },
    sizes: KIDS,
    isFeatured: false,
    isNew: true,
